...
export default class AddTournamentForm extends React.Component<Props, State> {
    ...
    private onInputChange = (e: React.ChangeEvent<HTMLInputElement> | React.ChangeEvent<HTMLTextAreaElement>): void => {
        this.setState(({
            ...this.state,
            ...
            <div className={classNames.wrapper}>
                <div className={classNames.form}>
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        ...
                        {this.renderTextInput('Facebook Event UTL (optional)', 'facebookEventUrl')}
                    </div>
                    ...
                    {this.renderTextAreaInput('Handicap Description', 'handicapDescription')}
                    <div style={{ display: 'flex' }}>
